...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QuizGroupCell_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QuizGroupCell_t qt_meta_stringdata_QuizGroupCell = {
    {
QT_MOC_LITERAL(0, 0, 13), // "QuizGroupCell"
QT_MOC_LITERAL(1, 14, 12), // "updateNotify"
...
const QMetaObject QuizGroupCell::staticMetaObject = {
    { &QuizCell::staticMetaObject, qt_meta_stringdata_QuizGroupCell.data,
      qt_meta_data_QuizGroupCell,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QuizGroupCell::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QuizGroupCell.stringdata0))
